...
import 'package:yshared_preferences/shared_preferences_platform_interface.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  group('YSharedPreferences', () {
    ...
    late YSharedPreferences preferences;

    setUp(() async {
      store = FakeSharedPreferencesStore(kTestValues);
      SharedPreferencesStorePlatform.instance = store;
      preferences = await YSharedPreferences.getInstance();
      store.log.clear();
    });
    ...
    test('reloading', () async {
      ...
      YSharedPreferences.setMockInitialValues(
    ...
    test('back to back calls should return same instance.', () async {
      final Future<YSharedPreferences> first = YSharedPreferences.getInstance();
      final Future<YSharedPreferences> second = YSharedPreferences.getInstance();
      expect(await first, await second);
    });

    test('string list type is dynamic (usually from method channel)', () async {
      YSharedPreferences.setMockInitialValues(<String, Object>{
        'dynamic_list': <dynamic>['1', '2']
      });
      final YSharedPreferences prefs = await YSharedPreferences.getInstance();
